...
Public Class Frm_VolumenCono
    ...
    Private Sub Txt_Volumen_TextChanged(sender As Object, e As EventArgs) Handles Txt_Volumen.TextChanged

    End Sub

    Private Sub Txt_Volumen_Validating(sender As Object, e As CancelEventArgs) Handles Txt_Volumen.Validating
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.errorValidacion.SetError(sender, "")
        Else
            Me.errorValidacion.SetError(sender, "Es un campo obligatorio")
